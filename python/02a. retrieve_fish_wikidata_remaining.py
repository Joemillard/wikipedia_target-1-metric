...
for i in range(0, len(traded_species)):
    try:
        #print(traded_species)
        url = "https://zh.wikipedia.org/w/api.php?action=query&prop=pageprops&ppprop=wikibase_item&redirects=1&titles=%s&format=json" % (traded_species[i])
...
save_loc = 'C:/Users/joeym/Documents/PhD/Aims/Aim 3 - quantifying pollinator cultural value/wikipedia_target-1-metric/wikipedia_target-1-metric/data/class_wiki_indices/submission_2/fished_species_wikidata_zh.csv'
