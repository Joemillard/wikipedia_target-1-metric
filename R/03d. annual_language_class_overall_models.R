...
random_trend <- readRDS(here::here("data/class_wiki_indices/submission_2/annual_overall_10-random-languages.rds"))
...
model_2 <- lm(av_lambda ~ taxonomic_class * language, data = final_bound)
summary(model_2)
